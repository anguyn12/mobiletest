!(function() {
  ...
  var n = {
      ...
      uniforms: {
        ...
        time: { name: "time", type: "f", glslType: "float", description: "" },
        color1: {
          name: null,
          type: "c",
          glslType: "vec3",
          value: { r: 1, g: 0.5411764705882353, b: 0.7294117647058823 },
          description: ""
        },
        color2: {
          name: null,
    ...
    e = {
      ...
      uniforms: {
        ...
        brightness: { value: "0.52098325", type: "f", glslType: "float" },
        speed: {
          value: { x: 0.9230769230769231, y: 0.9230769230769231 },
          type: "v2",
          glslType: "vec2"
        },
        color: {
        ...
        sunSpots: { value: "1", type: "f", glslType: "float" }
      },
    ...
    o = {
      ...
      uniforms: {
        ...
        noiseImage: { value: null, type: "t", glslType: "sampler2D" },
        distortion: { value: "2", type: "f", glslType: "float" },
        contrast: { value: "1.5", type: "f", glslType: "float" },
        ...
        Noise_Ripples1477531959288_166_color: {
          value: { r: 1, g: 0.2823529411764706, b: 0.4823529411764706 },
          type: "c",
          glslType: "vec3"
        },
        ...
        amplitude: { value: "2", type: "f", glslType: "float" },
        frequency: { value: "2", type: "f", glslType: "float" },
        highlightIntensity: { value: "0.4", type: "f", glslType: "float" },
        highlightColor: {
          value: { r: 1, g: 0.5450980392156862, b: 0.23529411764705882 },
          type: "c",
          glslType: "vec3"
        },
        ...
        Transparent_Glow1477532059126_201_color: {
          value: { r: 1, g: 0.5294117647058824, b: 0.8156862745098039 },
          type: "c",
          glslType: "vec3"
        },
    ...
    i = {
      ...
      uniforms: {
        time: { type: "f", glslType: "float" },
        image1: { value: null, type: "t", glslType: "sampler2D" },
        image2: { value: null, type: "t", glslType: "sampler2D" },
        ...
        Vertical_2_Color_Graident1547651045681_426_color2: {
          value: { r: 0, g: 0.9764705882352941, b: 0 },
          type: "c",
          glslType: "vec3"
        },
        ...
        brightness: { value: "0.25", type: "f", glslType: "float" },
    ...
    t = {
      ...
      uniforms: {
        ...
        noiseImage: { value: null, type: "t", glslType: "sampler2D" },
        distortion: { value: "1", type: "f", glslType: "float" },
        contrast: { value: "1.4", type: "f", glslType: "float" },
        Noise_Ripples1477531959288_166_speed: {
          value: "0.1",
          type: "f",
          glslType: "float"
        ...
        amplitude: { value: "0.2", type: "f", glslType: "float" },
        frequency: { value: "2", type: "f", glslType: "float" },
        highlightIntensity: { value: ".5", type: "f", glslType: "float" },
        highlightColor: {
          value: {
    ...
    r = {
      ...
      uniforms: {
        resolution: { value: "1", type: "f", glslType: "float" },
        image1: { value: null, type: "t", glslType: "sampler2D" },
        image2: { value: null, type: "t", glslType: "sampler2D" },
        time: { type: "f", glslType: "float" },
        ...
        map: { value: null, type: "t", glslType: "sampler2D" },
        diffuseColor: {
          value: {
        ...
        shininess: { value: "10", type: "f", glslType: "float" },
        scaleBias: {
          value: { x: "0.04", y: "0.001", z: 0 },
          type: "v2",
          glslType: "vec2"
        },
        ...
        scale: { value: "4", type: "f", glslType: "float" },
        Disco_Ball1532324436329_44_speed: {
          value: "1",
          type: "f",
          glslType: "float"
        },
        intensity: { value: "0.5", type: "f", glslType: "float" },
        spread: { value: "100", type: "f", glslType: "float" },
        ...
        mirrorReflection: { value: "1", type: "f", glslType: "float" },
        reflectionSampler: { value: null, type: "t", glslType: "samplerCube" }
      },
    ...
    a = {
      ...
      uniforms: {
        time: { type: "f", glslType: "float" },
        scale: { value: "30", type: "f", glslType: "float" },
        speed: { value: "1", type: "f", glslType: "float" }
      },
    ...
    l = {
      ...
      uniforms: {
        ...
        edgeWidth: { value: "0.1", type: "f", glslType: "float" },
        sharpness: { value: "100", type: "f", glslType: "float" },
        antSize: { value: "10", type: "f", glslType: "float" },
        antSpeed: { value: "1", type: "f", glslType: "float" },
        time: { type: "f", glslType: "float" }
      },
    ...
    _ = {
      ...
      uniforms: {
        scale: { value: ".8", type: "f", glslType: "float" },
        displacement: { value: ".5", type: "f", glslType: "float" },
        time: { type: "f", glslType: "float" },
        ...
        color: { value: { r: ".3", g: 0, b: 0 }, type: "c", glslType: "vec3" },
        color1: {
          value: { r: ".4", g: ".1", b: ".2" },
          type: "c",
          glslType: "vec3"
    ...
    c = {
      ...
      uniforms: {
        ...
        time: { type: "f", glslType: "float" },
        Randomise_Fractal: {
          value: { x: 0.5076923076923077, y: 0.7076923076923077 },
          type: "v2",
          glslType: "vec2"
        },
        NUM_SIDES: { value: "12", type: "f", glslType: "float" }
      },
    ...
    v = {
      ...
      uniforms: {
        time: { type: "f", glslType: "float" },
        color1: {
          value: { r: 0.95, g: 0.1, b: 0.8 },
          type: "c",
          glslType: "vec3"
        },
        color2: {
          value: { r: 0.7, g: 0.07, b: 0.6 },
          type: "c",
          glslType: "vec3"
        }
      },
    ...
    s = {
      ...
      uniforms: {
        ...
        amplitude: { value: "1", type: "f", glslType: "float" },
        frequency: { value: "20", type: "f", glslType: "float" },
        highlightIntensity: { value: "0.4", type: "f", glslType: "float" },
        highlightColor: {
          value: { r: 1, g: 0.5450980392156862, b: 0.23529411764705882 },
          type: "c",
    ...
    p = {
      ...
      uniforms: {
        cameraPosition: { type: "v3", glslType: "vec3" },
        time: { type: "f", glslType: "float" },
        resolution: { value: { x: "8", y: "9" }, type: "v2", glslType: "vec2" },
        speed: { value: ".2", type: "f", glslType: "float" },
        baseRadius: { value: ".2", type: "f", glslType: "float" },
        backgroundColor: {
          value: { r: 0, g: ".", b: "0.9" },
          type: "c",
          glslType: "vec3"
        },
        brightnessVariation: { value: "0", type: "f", glslType: "float" },
        colorVariation: { value: "0.99", type: "f", glslType: "float" },
        variation: { value: "50", type: "f", glslType: "float" }
      },
      ...
      w = {
  "id": 3580,
  "name": "Retrowave Grid Shader",
  "fragment": "#define PI 3.1415926535897932384626433832795\n\nprecision highp float;\nprecision highp int;\nuniform mat4 modelMatrix;\nuniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform mat4 viewMatrix;\nuniform mat3 normalMatrix;\nuniform vec3 cameraPosition;\nuniform float time;\nuniform vec3 Vertex_Distortion1560849408963_68_color;\nuniform vec3 lightPosition;\nuniform float cStrength;\nuniform float Caustic_Image_Based1560849517951_112_speed;\nuniform float Caustic_Image_Based1560849517951_112_resolution;\nuniform vec3 Caustic_Image_Based1560849517951_112_color;\nuniform sampler2D image;\nuniform float brightness;\nuniform float Circuit_Grid1560849579279_123_resolution;\nuniform float intensity;\nuniform float Circuit_Grid1560849579279_123_speed;\nuniform vec3 lightColor;\nuniform vec3 baseColor;\nvarying vec3 Vertex_Distortion1560849408963_68_vPosition;\nvarying vec3 Vertex_Distortion1560849408963_68_vNormal;\nvarying vec2 Vertex_Distortion1560849408963_68_vUv;\nvarying vec2 vUv2;\nconst vec3 cXaxis = vec3(100.0, 0.0, 0.0);\nconst vec3 cYaxis = vec3(0.0, 100.0, 0.0);\nconst vec3 cZaxis = vec3(0.0, 0.0, 100.0);\nvec4 twister(vec4 pos, float t) \n                                                {\n                                                    float st = sin(t);\n                                                    float ct = cos(t);\n                                                    vec4 new_pos = vec4(pos);\n                                                    new_pos.x = pos.x * ct - pos.z * st;\n                                                    new_pos.z = pos.x * st + pos.z * ct;\n                                                    new_pos.y = pos.y;\n                                                    new_pos.w = pos.w;\n                                                    return new_pos;\n                                                }\nvarying vec2 Caustic_Image_Based1560849517951_112_vUv;\nvarying vec3 Caustic_Image_Based1560849517951_112_vPosition;\nvarying vec3 Caustic_Image_Based1560849517951_112_vNormal;\nvec3 lig = normalize(vec3(0.9, 0.35, -0.2));\nvarying vec2 Circuit_Grid1560849579279_123_vUv;\nvarying vec3 Circuit_Grid1560849579279_123_vPosition;\nvec2 circuit(vec2 p) \n                                                {\n                                                    p = fract(p);\n                                                    float r = 0.3;\n                                                    float v = 0.0, g = 1.0;\n                                                    float d;\n                                                    const int iter = 7;\n                                                    for (int i = 0;\n i < iter; i++) \n                                                    {\n                                                        d = p.x - r;\n                                                        g += pow(clamp(1.0 - abs(d), 0.0, 1.0), 200.0);\n                                                        if (d > 0.0) \n                                                        {\n                                                            p.x = (p.x - r) / (1.8 - r);\n                                                        }\n else \n                                                        {\n                                                            p.x = p.x;\n                                                        }\n                                                        p = p.yx;\n                                                    }\n                                                    v /= float(iter);\n                                                    return vec2(g, v);\n                                                }\nvec4 Vertex_Distortion1560849408963_68_main() \n                                                {\n                                                    vec4 Vertex_Distortion1560849408963_68_gl_FragColor = vec4(0.0);\n                                                    vec3 worldPosition = (modelMatrix * vec4(Vertex_Distortion1560849408963_68_vPosition, 1.0)).xyz;\n                                                    vec3 worldNormal = normalize(vec3(modelMatrix * vec4(Vertex_Distortion1560849408963_68_vNormal, 0.0)));\n                                                    vec3 lightVector = normalize(lightPosition - worldPosition);\n                                                    float brightness = dot(worldNormal, lightVector);\n                                                    vec3 position = Vertex_Distortion1560849408963_68_vPosition;\n                                                    float howFarUp = position.y;\n                                                    vec3 directionVec = normalize(vec3(position));\n                                                    Vertex_Distortion1560849408963_68_gl_FragColor = vec4(directionVec, 1.0);\n                                                    return Vertex_Distortion1560849408963_68_gl_FragColor *= 1.0;\n                                                }\nvec4 Caustic_Image_Based1560849517951_112_main() \n                                                {\n                                                    vec4 Caustic_Image_Based1560849517951_112_gl_FragColor = vec4(0.0);\n                                                    vec2 uvMax = (2.0 * asin(sin(2.0 * PI * Caustic_Image_Based1560849517951_112_vUv))) / PI;\n                                                    vec2 position = Caustic_Image_Based1560849517951_112_vUv * Caustic_Image_Based1560849517951_112_resolution;\n                                                    vec3 nor = vec3(0.0, 1.0, 0.0);\n                                                    float dif = max(dot(nor, lig), 0.0);\n                                                    vec3 pos = vec3(position.x, 0.0, position.y);\n                                                    float timeScale = time * Caustic_Image_Based1560849517951_112_speed;\n                                                    vec3 brdf = vec3(0.0);\n                                                    float cc = 0.55 * texture2D(image, 1.8 * 0.02 * pos.xz + 0.007 * timeScale * vec2(1.0, 0.0)).x;\n                                                    cc += 0.25 * texture2D(image, 1.8 * 0.04 * pos.xz + 0.011 * timeScale * vec2(0.0, 1.0)).x;\n                                                    cc += 0.10 * texture2D(image, 1.8 * 0.08 * pos.xz + 0.014 * timeScale * vec2(-1.0, -1.0)).x;\n                                                    cc = 0.6 * (1.0 - smoothstep(0.0, 0.025, abs(cc - 0.4))) + 0.4 * (1.0 - smoothstep(0.0, 0.150, abs(cc - 0.4)));\n                                                    vec3 col = Caustic_Image_Based1560849517951_112_color * cc;\n                                                    Caustic_Image_Based1560849517951_112_gl_FragColor = vec4(Caustic_Image_Based1560849517951_112_color * cc * brightness, 1.0);\n                                                    return Caustic_Image_Based1560849517951_112_gl_FragColor *= 1.0;\n                                                }\nvec4 Circuit_Grid1560849579279_123_main() \n                                                {\n                                                    vec4 Circuit_Grid1560849579279_123_gl_FragColor = vec4(0.0);\n                                                    vec2 uv = (Circuit_Grid1560849579279_123_vUv.xy + 0.5) * Circuit_Grid1560849579279_123_resolution;\n                                                    vec2 cid2 = floor(uv);\n                                                    float cid = (cid2.y + cid2.x);\n                                                    vec2 dg = circuit(uv);\n                                                    float d = dg.x;\n                                                    vec3 col1 = (0.2 - vec3(max(min(d, 2.0) - 1.0, 0.0))) * baseColor;\n                                                    vec3 col2 = vec3(max(d - 1.0, 0.0)) * lightColor;\n                                                    float f = max(0.4 - mod(uv.y - uv.x + (time * Circuit_Grid1560849579279_123_speed) + (dg.y * 0.2), 2.5), 0.0) * intensity;\n                                                    col2 *= f;\n                                                    Circuit_Grid1560849579279_123_gl_FragColor = vec4(col1 + col2, 1.0);\n                                                    return Circuit_Grid1560849579279_123_gl_FragColor *= 1.0;\n                                                }\nvoid main() \n                                                {\n                                                    gl_FragColor = (Vertex_Distortion1560849408963_68_main() + Caustic_Image_Based1560849517951_112_main() + Circuit_Grid1560849579279_123_main());                                                }\n",
  "vertex": "precision highp float;\nprecision highp int;\nuniform mat4 modelMatrix;\nuniform mat4 modelViewMatrix;\nuniform mat4 projectionMatrix;\nuniform mat4 viewMatrix;\nuniform mat3 normalMatrix;\nuniform vec3 cameraPosition;\nuniform float time;\nuniform float cStrength;\nuniform float angle;\nattribute vec3 position;\nattribute vec3 normal;\nattribute vec2 uv;\nattribute vec2 uv2;\nvarying vec3 Vertex_Distortion1560849408963_68_vPosition;\nvarying vec3 Vertex_Distortion1560849408963_68_vNormal;\nvarying vec2 Vertex_Distortion1560849408963_68_vUv;\nvarying vec2 vUv2;\nconst vec3 cXaxis = vec3(1.0, 0.0, 0.0);\nconst vec3 cYaxis = vec3(0.0, 1.0, 0.0);\nconst vec3 cZaxis = vec3(0.0, 0.0, 1.0);\nvec4 twister(vec4 pos, float t) \n                                                {\n                                                    float st = sin(t);\n                                                    float ct = cos(t);\n                                                    vec4 new_pos = vec4(pos);\n                                                    new_pos.x = pos.x * ct - pos.z * st;\n                                                    new_pos.z = pos.x * st + pos.z * ct;\n                                                    new_pos.y = pos.y;\n                                                    new_pos.w = pos.w;\n                                                    return new_pos;\n                                                }\nvarying vec2 Caustic_Image_Based1560849517951_112_vUv;\nvarying vec3 Caustic_Image_Based1560849517951_112_vPosition;\nvarying vec3 Caustic_Image_Based1560849517951_112_vNormal;\nvarying vec2 Circuit_Grid1560849579279_123_vUv;\nvarying vec3 Circuit_Grid1560849579279_123_vPosition;\nvec4 Vertex_Distortion1560849408963_68_main() \n                                                {\n                                                    vec4 Vertex_Distortion1560849408963_68_gl_Position = vec4(0.0);\n                                                    Vertex_Distortion1560849408963_68_vNormal = normal;\n                                                    Vertex_Distortion1560849408963_68_vUv = uv;\n                                                    vUv2 = uv2;\n                                                    Vertex_Distortion1560849408963_68_vPosition = position;\n                                                    float howFarUp = position.y;\n                                                    vec3 directionVec = normalize(vec3(position));\n                                                    float xangle = dot(cXaxis, directionVec) * 5.0;\n                                                    float yangle = dot(cYaxis, directionVec) * 6.0;\n                                                    float zangle = dot(cZaxis, directionVec) * 4.5;\n                                                    float mTime = time * 1.05;\n                                                    float cosx = cos(mTime + xangle);\n                                                    float sinx = sin(mTime + xangle);\n                                                    float cosy = cos(mTime + yangle);\n                                                    float siny = sin(mTime + yangle);\n                                                    float cosz = cos(mTime + zangle);\n                                                    float sinz = sin(mTime + zangle);\n                                                    vec3 timeVec = position;\n                                                    timeVec.x += directionVec.x * cosx * siny * cosz * cStrength;\n                                                    timeVec.y += directionVec.y * sinx * cosy * sinz * cStrength;\n                                                    timeVec.z += directionVec.z * sinx * cosy * cosz * cStrength;\n                                                    float twistAngle = angle * howFarUp;\n                                                    vec4 twistedPosition = twister(vec4(position, 1.0), twistAngle);\n                                                    vec4 twistedNormal = twister(vec4(normal, 1.0), twistAngle);\n                                                    Vertex_Distortion1560849408963_68_vNormal = twistedNormal.xyz;\n                                                    Vertex_Distortion1560849408963_68_gl_Position = projectionMatrix * modelViewMatrix * vec4(timeVec + twistedPosition.xyz, 1.0);\n                                                    return Vertex_Distortion1560849408963_68_gl_Position *= 1.0;\n                                                }\nvec4 Caustic_Image_Based1560849517951_112_main() \n                                                {\n                                                    vec4 Caustic_Image_Based1560849517951_112_gl_Position = vec4(0.0);\n                                                    Caustic_Image_Based1560849517951_112_vUv = uv;\n                                                    Caustic_Image_Based1560849517951_112_vPosition = position;\n                                                    Caustic_Image_Based1560849517951_112_vNormal = normal;\n                                                    Caustic_Image_Based1560849517951_112_gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n                                                    return Caustic_Image_Based1560849517951_112_gl_Position *= 1.0;\n                                                }\nvec4 Circuit_Grid1560849579279_123_main() \n                                                {\n                                                    vec4 Circuit_Grid1560849579279_123_gl_Position = vec4(0.0);\n                                                    Circuit_Grid1560849579279_123_vUv = uv;\n                                                    Circuit_Grid1560849579279_123_vPosition = position;\n                                                    Circuit_Grid1560849579279_123_gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n                                                    return Circuit_Grid1560849579279_123_gl_Position *= 1.0;\n                                                }\nvoid main() \n                                                {\n                                                    gl_Position = Vertex_Distortion1560849408963_68_main() + Caustic_Image_Based1560849517951_112_main() + Circuit_Grid1560849579279_123_main();                                                }\n",
  "uniforms": {
    "cameraPosition": {
      "type": "v3",
      "glslType": "vec3"
    ...
    "Vertex_Distortion1560849408963_68_color": {
      "value": {
        "r": 0.6823529411764706,
    ...
    "Caustic_Image_Based1560849517951_112_color": {
      "value": {
        "r": 1,
        "g": 1,
        "b": 1
    ...
    "Caustic_Image_Based1560849517951_112_speed": {
      "value": "0.2",
      "type": "f",
      "glslType": "float"
    },
    "Caustic_Image_Based1560849517951_112_resolution": {
      "value": "0.5",
      "type": "f",
      "glslType": "float"
    },
    ...
    "Circuit_Grid1560849579279_123_resolution": {
      "value": "6",
      "type": "f",
      "glslType": "float"
    },
    "Circuit_Grid1560849579279_123_speed": {
      "value": "1",
      "type": "f",
      "glslType": "float"
    }
  },
  "url": "http://shaderfrog.com/app/view/3580",
  "user": {
    "username": "dankpvt",
    "url": "http://shaderfrog.com/app/profile/andrewray"
  }
    ...
    m = {
      ...
      uniforms: {
        cameraPosition: { type: "v3", glslType: "vec3" },
        time: { type: "f", glslType: "float" },
        opacity: { value: "0.4", type: "f", glslType: "float" }
      },
      side: 2,
    ...
    g = {
      ...
      uniforms: {
        time: { type: "f", glslType: "float" },
        color: {
          value: { r: 0.7176470588235294, g: 0, b: 0 },
          type: "c",
          glslType: "vec3"
        },
        resolution: {
        ...
        background_color: {
          value: { r: 0, g: 0.8156862745098039, b: 1 },
          type: "c",
          glslType: "vec3"
        }
      },
  ...
  function y(n, ...e) {
    let o,
      i,
      t = x(n);
    for (o = 0; (i = e[o++]); ) delete t[i];
    return t;
  }
  (f.Polkadot_Shader = n),
    (f.Sun_Shader = e),
    (f.Jelly_Shader = o),
    (f.Green_Dance_Shader = i),
    (f.Cosmic_Shader = t),
    (f.Cool_Tiles_Shader = r),
    (f.Disco_Shader = a),
    (f.Marching_Ants_Shader = l),
    (f.Goo_Shader = _),
    (f.Psycho_Shader = c),
    (f.Ova_Shader = v),
    (f.Thruster_Shader = s),
    (f.Flowing_Circles_Shader = p),
    (f.Retrowave_Grid_Shader = w),
    (f.Electric_Shader = m),
    (f.CS1_Shader = g),
    (AFRAME.shaderfrog = f),
    (u.prototype = {
      ...
      registerCubeCamera(n, e) {
        if (!e.renderTarget)
          throw new Error("Cannot register a non-camera as a camera!");
        this.cubeCameras[n] = e;
      },
      unregisterCamera(n) {
        if (n in this.cubeCameras) delete this.cubeCameras[n];
        else {
          if (n !== this.mainCamera)
            throw new Error("You never registered camera " + n);
          delete this.mainCamera;
        }
      },
      updateSource(n, e, o) {
        if (((o = o || "name"), !this.shaderTypes[n]))
          throw new Error(
        ...
        let i,
          t,
          r = this.add(n, e);
        for (t = 0; (i = this.runningShaders[t++]); )
          i[o] === n &&
            (d(i.material, y(r, "id")), (i.material.needsUpdate = !0));
      },
      renameShader(n, e) {
        let o, i;
        if (!(n in this.shaderTypes))
          throw new Error(
            "Could not rename shader " + n + " to " + e + ". It does not exist."
          );
        for (
          this.shaderTypes[e] = this.shaderTypes[n],
            delete this.shaderTypes[n],
            o = 0;
          (i = this.runningShaders[o++]);

        )
          i.name === n && (i.name = e);
      },
      get(n) {
        let e = this.shaderTypes[n];
        return e.initted || this.create(n), e.material;
      },
      add(n, e) {
        let o,
          i = x(e);
        for (var t in ((i.fragmentShader = e.fragment),
        (i.vertexShader = e.vertex),
        delete i.fragment,
        delete i.vertex,
        i.uniforms))
          null === (o = i.uniforms[t]).value &&
            (i.uniforms[t].value = this.getUmap(o.glslType));
        return (
          n in this.shaderTypes
            ? d(this.shaderTypes[n], i)
            : (this.shaderTypes[n] = i),
          i
        );
      },
      create(n) {
        ...
        return (
          delete e.id,
          (e.material = new THREE.RawShaderMaterial(e)),
          this.runningShaders.push(e),
          e.init && e.init(e.material),
      ...
      updateRuntime(n, e, o) {
        let i, t, r, a;
        for (o = o || "name", t = 0; (i = this.runningShaders[t++]); )
          if (i[o] === n)
            for (r in e.uniforms)
              r in this.reserved ||
                (r in i.material.uniforms &&
                  ("t" === (a = e.uniforms[r]).type &&
                    "string" == typeof a.value &&
                    (a.value = this.cubeCameras[a.value].renderTarget),
                  (i.material.uniforms[r].value = e.uniforms[r].value)));
      },
      updateShaders(n, e) {
        let o, i;
        for (e = e || {}, i = 0; (o = this.runningShaders[i++]); ) {
          for (let n in e.uniforms)
            n in o.material.uniforms &&
              (o.material.uniforms[n].value = e.uniforms[n]);
          "cameraPosition" in o.material.uniforms &&
            this.mainCamera &&
            (o.material.uniforms.cameraPosition.value = this.mainCamera.position.clone()),
            "viewMatrix" in o.material.uniforms &&
              this.mainCamera &&
              (o.material.uniforms.viewMatrix.value = this.mainCamera.matrixWorldInverse),
            "time" in o.material.uniforms &&
              (o.material.uniforms.time.value = n);
        }
      },
      shaderTypes: f,
      runningShaders: []
    ...
    AFRAME.registerSystem("shader-frog", {
      init: function() {
        (this.frog_runtime = new u()), (this.clock = new THREE.Clock());
        var n = this,
          e = document.querySelector("a-scene");
        function o() {
          var e = document.querySelector("a-scene").systems.camera;
          e &&
            e.sceneEl &&
            e.sceneEl.camera &&
            ((e = e.sceneEl.camera), n.frog_runtime.registerCamera(e));
        }
        e.hasLoaded ? o().bind(this) : e.addEventListener("loaded", o);
      },
      tick: function(n) {
    ...
    AFRAME.registerComponent("shader-frog", {
      schema: { name: { type: "string", default: "Flowing_Circles_Shader" } },
      init: function() {
        (this.originalMaterial = this.el.getObject3D("mesh").material),
          (this.shaderData = f[this.data.name]);
      },
      update: function() {
        this.system.frog_runtime.add(this.data.name, this.shaderData);
        var n = this.system.frog_runtime.get(this.data.name);
        this.el.getObject3D("mesh").material = n;
      },
      remove: function() {
